...
const ThursdayDeal = ({ data }) => {
	...
	const handleCart = () => {
		if (selectedItem) {
			itemTitle =
				`One 15'(Large) ${selectedItem.item["itemTitle"]}`.toLowerCase();
				...
				<>
					<div className="promotion-deal">
						...
						>
							...
							>
								Thursday Special Deal
							</p>
							<p className="topic">
								Get a 15'(Large) Specialty Pizza only for just
								$21.
							</p>
						</div>

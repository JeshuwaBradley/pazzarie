...
const FridayDeal = ({ data }) => {
	...
	const handleCart = () => {
		if (selectedItem) {
			itemTitle =
				`One 15'(Large) ${selectedItem.item["itemTitle"]} & one regular cheese bread`.toLowerCase();
				...
				<>
					<div className="promotion-deal">
						...
						>
							...
							<p className="topic">
								Get any large Specialty Pizza and a regular
								Cheese Bread for only just $33
							</p>
						</div>
